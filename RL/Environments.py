...
class DoubleIntegrator1D:
    def __init__(self, delta_t=0.05, target_x=0, x_bound=[-10, 10], v_bound=[-5, 5], x_epsilon=0.1, vx_epsilon=0.05):
    ...
    def reset(self):
        # self.x = random.uniform(self.x_bound[0], self.x_bound[1])
        # self.vx = random.uniform(self.v_bound[0], self.v_bound[1]) 
        self.x = 5
        self.vx = 0.5
